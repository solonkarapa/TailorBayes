...
## Custom weights
The construction weights is controlled by the `distance_measure` and `espilon` arguments. Together they allow the specification of a family of weigthing functions, termed $\epsilon$-insensitive functions [@vapnik1998statistical]. The family is defined as
