...
The construction weights is controlled by the `distance_measure` and `epsilon` arguments. Together they allow the specification of a family of weighting functions, $h$, termed $\epsilon$-insensitive functions [@vapnik1998statistical]. The family is defined as
