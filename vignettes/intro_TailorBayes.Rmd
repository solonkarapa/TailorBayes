...
method: we use standard unweighted frequentist logistic regression below but any other classifiers that output probability estimates will do. 
...
First, we will use the design data to estimate $\pi_u(x_i)$. I use frequentist logistic regression for this. 
...
For instance, we can plot diagnostic such as traceplots
