...
Tailor Bayes (TB), allows for the incorporation of misclassification costs into Bayesian modelling. In a nutshell, this is done by introducing datapoint-specific weights which are used to downweight each datapoint's likelihood contribution when fitting the model.
