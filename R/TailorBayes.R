...
#' functions provided by the coda package. See function doc for details on the model.
#'
#' The \code{ESS_t()} functions calculates the effective sample size for tailoring, i.e., the sample size
